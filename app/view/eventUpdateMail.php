        ...
        <tbody>
          <tr>
            <td style="text-align:center;vertical-align:top;direction:ltr;font-size:0px;padding:40px 0px">
              <div aria-labelledby="mj-column-per-100" class="m_-8728579132731280445mj-column-per-100"
                        ...
                        <td style="word-break:break-word;font-size:0px;padding:0px" align="left">
                          <div
                            ...
                            <h2
                              ...
                              <p><?php if($volunteered_date_changed == true){echo $event_name." event informations has been changed.Please volunteer again..!";} else{echo $event_name." event informations has been changed.";}?> </p>
                    ...
                    <tr>
                      <td style="word-break:break-word;font-size:0px;padding:0px" align="center">
                        <div
                          ...
                          Sent by Communityretreat • University of Colombo School of Computing
                        </div>
                      </td>
                    </tr>
                  </tbody>

                      ...
                      <tr>
                        <td style="word-break:break-word;font-size:0px;padding:0px" align="left">
                          <div
                            ...
                            <p>Thanks for registering for an account on Communityretreat! Before we get started, we just
                              need to confirm that this is you. Click below to verify your email address:</p>

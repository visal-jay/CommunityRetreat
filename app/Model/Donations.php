...
class Donations extends Model
{
   ...
   /* public function getDonateDetails($event_id, $offset, $no_of_records_per_page)
    ...
    public function disableDonation($event_id)
    ...
    public function enableDonation($event_id)
    ...
    {/*give a donation capacity for an event from the UI to store in backend*/
    ...
    {/*set donation_status as credited in the donation table*/
    ...
    {
        $query = "SELECT uid, event_id, amount, intent_id FROM donation WHERE event_id =:event_id AND donation_status ='debit' ";
        $params = ["event_id" => $event_id];
        $result = Model::select($query, $params);
        return $result;
    }

                    ...
                    <!--username update form-->
                        ...
                        <form action="/User/updateUsername" method="post" class="update-form" id="usernameupdater">
                            <div class="input-container">
                                ...
                                <input type="text" id="usernameinput" class="form-ctrl" value=<?= $username?> name="username" required><br>
                    ...
                    <!--mobile update form-->
                        ...
                        <form action="/User/updateContactNumber" method="post" class="update-form" id="mobileupdater">
                            <div class="input-container">
                                ...
                                <input type="tel" placeholder="Enter new mobile" class="form-ctrl" value="<?= $contact_number ?>"  name="contact_number" onkeyup="checkTelephone(this.value)" required><br>

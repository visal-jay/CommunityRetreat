...
<body>
    ...
    <div class="feedback-container">
        <form action="/Systemfeedback/getSystemFeedbacks" method="post" class="feedback-form">
            ...
            <textarea cols="40" rows="8" placeholder="Describe here" class="form-ctrl" style="resize:none;"
    ...
    <footer class="main-footer">
        ...
        <?php }?>
        <div class="copyright">
            <p style="color:gray; margin: 1.5rem 0;"><i class="far fa-copyright"></i>&nbsp2021 Community Retreat, All
                Right Reserved.</p>
        </div>
        <a class=" logo ">
